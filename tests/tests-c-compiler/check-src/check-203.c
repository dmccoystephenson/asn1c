 ...
 * in constr_CHOICE_ber.c, constr_SEQUENCE_ber.c, constr_SET_ber.c, and
 * constr_SET_OF_ber.c.  The CHOICE case spins forever; the others fall
 * through to wrong code paths.  All four must return RC_FAIL promptly.
 *
 ...
 *
 * See upstream https://github.com/vlm/asn1c/pull/518
 */
